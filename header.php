...
<body <?php body_class(); ?>
  <body> 
    <div id="wrap"> 
      <div id="header"> 
        <div id="header_logo"> 
          <a href="/"><img src="/wp-content/themes/wedy/images/logo_aperoentrepreneurs_fin.png" alt="logo"/>
</a> 
        </div> 
...
<option value="/villefranche-sur-saone/show/">Villefranche sur Saône</option>
    ...
    <input id="city_search_bar" name="address" placeholder="Search a city" size="20" type="text">
